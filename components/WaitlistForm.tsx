      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-md mx-auto">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="bg-[#12131A] border-[#1F2030] text-white placeholder:text-gray-600 focus:border-red-500 focus:ring-red-500 h-12"
            disabled={loading}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full px-3 text-sm py-3 bg-[#12131A] border border-[#1F2030] text-white rounded-md focus:border-red-500 focus:ring-red-500 focus:outline-none h-12"
            disabled={loading}
          >
        ...
        <Button
          ...
          size="lg"
          disabled={loading}
          className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-4 text-lg transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
